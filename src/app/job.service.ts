...
export class JobService extends BaseService {
  ...
  getCustomer(id) {
    ...
    return this.http.get<any>(url_api + 'customers/' + id, { headers: this.getHeaders(), params: params })
      .pipe(map(data => {
        if (data) {
          return data;
        }
  ...
  getKeeping(id) {
    ...
    return this.http.get<any>(`${url_api}account/keeping_renew/${id}`, { headers: this.getHeaders(), params: params })
      .pipe(map(data => {
        if (data) {
          return data;
        }
  ...
  addPayment(id: number,data: object) {
    ...
    return this.http.post<any>(url_api + 'account/keeping_payment_history/'+id, data, { headers: this.getHeaders() })
      .pipe(map(data => {
        if (data) {
          return data;
        }
